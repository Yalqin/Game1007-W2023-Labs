...
void PlayScene::Start()
{
	...
	// Plane Sprite
	// Scenes have GameObjects as "children" of a Heirarchy
	m_pPlaneSprite = new Plane();
	//This AddChild function adds the passed variable to be included in a list of objects to update and draw
